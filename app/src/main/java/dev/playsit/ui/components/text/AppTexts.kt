...
@Composable
fun CategoryTitleText(text: String, modifier: Modifier = Modifier) {
...
@Composable
fun DefaultGrayText(text: AnnotatedString, fontSize: TextUnit = 14.sp, modifier: Modifier = Modifier) {
    Text(
        text = text,
        fontWeight = FontWeight.Normal,
        fontSize = fontSize,
